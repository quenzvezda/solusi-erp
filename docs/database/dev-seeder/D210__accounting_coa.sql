...
('4240', 'Foreign Exchange Gain',              'REVENUE',   'CREDIT', @coa_contra_sales,      3, 0, 'Gain from exchange rate differences on AP documents.',   1, 1, 1, NOW(), 1, NOW()),
...
('5140', 'Foreign Exchange Loss',              'EXPENSE',   'DEBIT',  @coa_cost_of_sales,     3, 0, 'Loss from exchange rate differences on AP documents.',   1, 1, 1, NOW(), 1, NOW()),
