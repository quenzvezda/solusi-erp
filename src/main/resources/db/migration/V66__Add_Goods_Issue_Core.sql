...
CREATE TABLE IF NOT EXISTS inv_goods_issues (
    ...
    KEY idx_gi_status (status),
    KEY idx_gi_issue_date (issue_date),
    KEY idx_gi_reference_type_id (reference_type, reference_id),
    KEY idx_gi_party_type_id (party_type, party_id),
    KEY idx_gi_facility (facility_id),
...
CREATE TABLE IF NOT EXISTS inv_goods_issue_lines (
    ...
    updated_date          DATETIME      NULL,
    PRIMARY KEY (id),
    KEY idx_gil_reference_line (reference_line_id),
    KEY idx_gil_valuation_ref (valuation_ref_type, valuation_ref_id, valuation_ref_line_id),
...
-- ============================================================
-- 6. Grant all goods issue permissions to ROLE_ADMIN
-- ============================================================
