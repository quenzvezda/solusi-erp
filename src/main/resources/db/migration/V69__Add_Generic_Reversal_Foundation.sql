ALTER TABLE inv_movements
    ADD COLUMN reversal_of_movement_id BIGINT NULL AFTER reference_code,
    ADD CONSTRAINT fk_inv_mov_reversal_of
        FOREIGN KEY (reversal_of_movement_id) REFERENCES inv_movements(id),
    ADD CONSTRAINT uk_inv_mov_reversal_of UNIQUE (reversal_of_movement_id);
...
ALTER TABLE inv_valuation_layers
    ADD COLUMN reversal_of_movement_id BIGINT NULL AFTER reference_line_id,
    ADD CONSTRAINT fk_val_layer_reversal_of_movement
        FOREIGN KEY (reversal_of_movement_id) REFERENCES inv_movements(id);
