...
ALTER TABLE ap_vendor_bills
    ADD COLUMN document_status VARCHAR(30) NULL AFTER status,
    ADD COLUMN settlement_status VARCHAR(30) NULL AFTER document_status;
...
ALTER TABLE ap_vendor_bills
    MODIFY COLUMN document_status VARCHAR(30) NOT NULL;
