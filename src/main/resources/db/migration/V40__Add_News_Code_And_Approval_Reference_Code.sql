...
ALTER TABLE common_news ADD COLUMN IF NOT EXISTS code VARCHAR(50) NOT NULL DEFAULT '' AFTER id;
...
ALTER TABLE common_news ADD UNIQUE KEY IF NOT EXISTS uk_news_code (code);
...
ALTER TABLE appr_requests ADD COLUMN IF NOT EXISTS reference_code VARCHAR(100) AFTER reference_id;
