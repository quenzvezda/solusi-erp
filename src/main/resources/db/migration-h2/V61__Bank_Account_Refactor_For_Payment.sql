...
ALTER TABLE bank_accounts ADD COLUMN currency_id BIGINT NULL;
ALTER TABLE bank_accounts ADD COLUMN coa_id BIGINT NULL;
ALTER TABLE bank_accounts ADD CONSTRAINT fk_bank_account_currency FOREIGN KEY (currency_id) REFERENCES master_currencies(id);
ALTER TABLE bank_accounts ADD CONSTRAINT fk_bank_account_coa FOREIGN KEY (coa_id) REFERENCES acc_chart_of_accounts(id);
