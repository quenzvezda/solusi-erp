...
-- 3. Drop old columns
ALTER TABLE acc_accounting_schemas DROP CONSTRAINT fk_schema_debit;
ALTER TABLE acc_accounting_schemas DROP CONSTRAINT fk_schema_credit;
ALTER TABLE acc_accounting_schemas DROP CONSTRAINT fk_schema_tax;

ALTER TABLE acc_accounting_schemas DROP COLUMN debit_account_id;
ALTER TABLE acc_accounting_schemas DROP COLUMN credit_account_id;
ALTER TABLE acc_accounting_schemas DROP COLUMN tax_account_id;