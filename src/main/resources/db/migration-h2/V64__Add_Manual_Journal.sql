ALTER TABLE acc_journal_entries ADD COLUMN currency_id BIGINT NULL;
ALTER TABLE acc_journal_entries ADD COLUMN exchange_rate DECIMAL(19,6) NULL;
ALTER TABLE acc_journal_entries ADD COLUMN reference_no VARCHAR(100) NULL;
ALTER TABLE acc_journal_entries ADD COLUMN reversal_of_id BIGINT NULL;
ALTER TABLE acc_journal_entries ALTER COLUMN source_id BIGINT NULL;
ALTER TABLE acc_journal_entries ADD CONSTRAINT fk_acc_journal_entries_currency
    FOREIGN KEY (currency_id) REFERENCES master_currencies(id);
ALTER TABLE acc_journal_entries ADD CONSTRAINT fk_acc_journal_entries_reversal_of
    FOREIGN KEY (reversal_of_id) REFERENCES acc_journal_entries(id);
ALTER TABLE acc_journal_entries ADD CONSTRAINT uk_acc_journal_entries_reversal_of UNIQUE (reversal_of_id);

ALTER TABLE acc_journal_lines ADD COLUMN description VARCHAR(255) NULL;
