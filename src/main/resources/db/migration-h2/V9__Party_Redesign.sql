...
-- ============================================================
ALTER TABLE parties
    ADD COLUMN salutation VARCHAR(50) NULL;

-- ============================================================
-- 2. Soft-delete on party_addresses (isActive + isDefault)
-- ============================================================
ALTER TABLE party_addresses ADD COLUMN is_active BOOLEAN NOT NULL DEFAULT TRUE;
ALTER TABLE party_addresses ADD COLUMN is_default BOOLEAN NOT NULL DEFAULT FALSE;

-- ============================================================
-- 3. Soft-delete on party_identifications (isActive + isDefault)
-- ============================================================
ALTER TABLE party_identifications ADD COLUMN is_active BOOLEAN NOT NULL DEFAULT TRUE;
ALTER TABLE party_identifications ADD COLUMN is_default BOOLEAN NOT NULL DEFAULT FALSE;
