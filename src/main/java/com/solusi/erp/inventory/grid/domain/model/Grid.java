...
public class Grid {
    ...
    public Grid(AuditMetadata metadata, Long facilityId, String facilityName, String facilityCode,
    ...
    public static Grid createNew(Long facilityId, String code, String name, String note, Boolean isActive) {
        return new Grid(AuditMetadata.empty(), facilityId, null, null, code, name, note, isActive);
    }
