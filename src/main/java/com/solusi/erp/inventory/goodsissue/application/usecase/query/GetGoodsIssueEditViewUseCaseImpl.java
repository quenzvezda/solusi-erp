...
public class GetGoodsIssueEditViewUseCaseImpl implements GetGoodsIssueEditViewUseCase {

    private final GoodsIssueRepository goodsIssueRepository;

    public GetGoodsIssueEditViewUseCaseImpl(GoodsIssueRepository goodsIssueRepository) {
