...
public interface GoodsReceiptReferenceLookupProvider {
    ...
    Map<Long, ReferenceLineSnapshot> resolveReferenceLineSnapshots(GoodsReceiptReferenceType referenceType, Long referenceId);

    record ReferenceLineSnapshot(BigDecimal orderedQuantity,
                                 BigDecimal receivedToDateQuantity,
