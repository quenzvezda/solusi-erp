...
public enum JournalVariable {
    ...
    DMA_AP_AMT(SchemaEventType.DEBIT_MEMO_APPLICATION),
    DMA_GRIR_CLEARING_AMT(SchemaEventType.DEBIT_MEMO_APPLICATION),
    DMA_TAX_AMT(SchemaEventType.DEBIT_MEMO_APPLICATION),
    DMA_FX_LOSS_AMT(SchemaEventType.DEBIT_MEMO_APPLICATION),
    DMA_FX_GAIN_AMT(SchemaEventType.DEBIT_MEMO_APPLICATION),
