...
public class BankAccountRepositoryImpl implements BankAccountRepository {
    ...
    public BankAccount save(BankAccount domain) {
        com.solusi.erp.master.bankaccount.infrastructure.persistence.BankAccount entity = mapper.toEntity(domain);
        ...
        com.solusi.erp.master.bankaccount.infrastructure.persistence.BankAccount saved = jpaRepository.save(entity);
    ...
    public Page<BankAccount> findAll(String keyword, Pageable pageable) {
        ...
        org.springframework.data.domain.Page<com.solusi.erp.master.bankaccount.infrastructure.persistence.BankAccount> springPage =
