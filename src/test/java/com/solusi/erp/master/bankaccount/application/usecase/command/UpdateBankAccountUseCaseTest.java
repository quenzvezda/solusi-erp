...
class UpdateBankAccountUseCaseTest {
    ...
    void execute_updatesMutableFieldsOfExistingBankAccount() {
        ...
        BankAccount existing = new BankAccount(metadata, "BA-001", "Old Bank", "Old Branch",
                "Old Name", "000", PaymentType.CASH, "Old Note",
                1L, "Jakarta", 2L, "PT ABC", true, 1L, null);
        ...
        BankAccount result = useCase.execute(1L, "New Bank", "New Branch", "New Name",
                "999", PaymentType.BANK_TRANSFER, "New Note", 3L, 4L, false, 2L, 10L);
        ...
        assertThat(result.getAccountType()).isEqualTo(PaymentType.BANK_TRANSFER);
        assertThat(result.getCurrencyId()).isEqualTo(2L);
    ...
    void execute_throwsDomainException_whenBankAccountNotFound() {
        ...
        assertThrows(DomainException.class,
                () -> useCase.execute(99L, "Name", "Branch", "AccName", "000",
                        PaymentType.BANK_TRANSFER, "Note", 1L, 2L, true, 1L, null));
    }
}
