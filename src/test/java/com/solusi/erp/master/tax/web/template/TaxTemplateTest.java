package com.solusi.erp.master.tax.web.template;
...
public class TaxTemplateTest {
    ...
    public void templateReferencesValidProperties() throws Exception {
        InputStream is = getClass().getClassLoader().getResourceAsStream("templates/master/tax/list.html");
        ...
        while (m.find()) {
            ...
            for (java.lang.reflect.Field f : TaxSummaryResponse.class.getDeclaredFields()) {
            ...
            for (java.lang.reflect.Method method : TaxSummaryResponse.class.getMethods()) {
            ...
            assertThat(hasField || hasGetter)
                    .withFailMessage("Property '%s' referenced in template but not present on %s",
                            prop, TaxSummaryResponse.class.getName())
                    .isTrue();
        }
    }
    ...
    public void templateContainsExpectedPlaceholders() throws Exception {
        ...
        assertThat(template).contains("tax-table-container");
