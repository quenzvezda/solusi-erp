...
@DisplayName("CancelVendorBillUseCase Tests")
class CancelVendorBillUseCaseTest {

    private InMemoryVendorBillRepository vendorBillRepository;
    private CancelVendorBillUseCase useCase;

    @BeforeEach
    void setUp() {
        vendorBillRepository = new InMemoryVendorBillRepository();
        useCase = new CancelVendorBillUseCaseImpl(vendorBillRepository);
    }

    @Test
    void cancel_should_reject_non_draft_bill() {
