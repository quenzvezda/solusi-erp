...
class DebitMemoTemplateTest {
    ...
    void list_template_should_expose_filters_and_view_action() throws Exception {
        ...
        assertThat(template).contains("data-lookup-path=\"parties\"");
        ...
        assertThat(template).contains("sortable('code'");
        assertThat(template).contains("sortable('memoDate'");
        assertThat(template).contains("sortable('vendorId'");
        assertThat(template).contains("sortable('settlementStatus'");
        assertThat(template).contains("label.debit-memo.gross");
        assertThat(template).contains("label.debit-memo.remaining");
        assertThat(template).contains("item.vendorName");
