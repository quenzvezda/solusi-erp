package com.solusi.erp.inventory.container.web.template;
...
public class ContainerTemplateTest {
    ...
    public void templateReferencesValidProperties() throws Exception {
        InputStream is = getClass().getClassLoader().getResourceAsStream("templates/inventory/containers/list.html");
        ...
        while (m.find()) {
            ...
            for (java.lang.reflect.Field f : ContainerSummaryResponse.class.getDeclaredFields()) {
            ...
            for (java.lang.reflect.Method method : ContainerSummaryResponse.class.getMethods()) {
            ...
            assertThat(hasField || hasGetter)
                .withFailMessage("Property '%s' referenced in template but not in %s", prop, ContainerSummaryResponse.class.getName())
                .isTrue();
        }
    }
    ...
    public void templateContainsExpectedPlaceholders() throws Exception {
        ...
        assertThat(template).contains("container-table-container");
        ...
        assertThat(template).contains("${item.gridName}");
    }
}
