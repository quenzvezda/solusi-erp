package com.solusi.erp.inventory.uom.web.template;
...
public class UomTemplateTest {

    @Test
    public void templateReferencesValidProperties() throws Exception {
        InputStream is = getClass().getClassLoader()
            .getResourceAsStream("templates/inventory/unit-of-measures/list.html");
        ...
        while (m.find()) {
            ...
            for (java.lang.reflect.Field f : UomSummaryResponse.class.getDeclaredFields()) {
            ...
            for (java.lang.reflect.Method method : UomSummaryResponse.class.getMethods()) {
            ...
            assertThat(hasField || hasGetter)
                .withFailMessage("Property '%s' referenced in template but not present on %s",
                    prop, UomSummaryResponse.class.getName())
                .isTrue();
        }
    }
    ...
    public void templateContainsExpectedPlaceholders() throws Exception {
        ...
        assertThat(template).contains("uom-table-container");
    ...
    @Test
    public void formTemplateContainsExpectedAttributes() throws Exception {
        InputStream is = getClass().getClassLoader()
            .getResourceAsStream("templates/inventory/unit-of-measures/form.html");
        String template = new String(is.readAllBytes(), StandardCharsets.UTF_8);

        assertThat(template).contains("unitOfMeasureRequest");
    }
}
